...
# File run_analysis.R
# Description: Using data collected from the accelerometers from the Samsung Galaxy S smartphone,
# work with the data and make a clean data set, outputting the resulting
# tidy data into a file named "tidy_data.txt".
# See README.md for more details.
setwd("D:/Data Science Specialization/RProgrammingWork/Getting and Cleaning Data Course Project/UCI HAR Dataset")
options("repos")[[1]][1]
